...
namespace CCompiler.AST {
    ...
    public abstract class BinaryIntegralOp : BinaryOp {
        ...
        public abstract int OperateLong(int left, int right);
        public abstract uint OperateULong(uint left, uint right);
    ...
    public abstract class BinaryLogicalOp : BinaryOp {
        ...
        public abstract int OperateLong(int left, int right);
        public abstract int OperateULong(uint left, uint right);
        public abstract int OperateFloat(Single left, Single right);
        public abstract int OperateDouble(Double left, Double right);
    ...
    public sealed class Multiply : BinaryArithmeticOp {
        ...
        public override int OperateLong(int left, int right) => left * right;
        public override uint OperateULong(uint left, uint right) => left * right;
    ...
    public sealed class Add : BinaryArithmeticOp {
        ...
        public ABT.Expr GetPointerAddition(ABT.Expr ptr, ABT.Expr offset, Boolean order = true) {
            ...
            if (ptr.IsConstExpr && offset.IsConstExpr) {
                var baseValue = (int)((ABT.ConstPtr)ptr).Value;
                int scaleValue = ((ABT.PointerType)(ptr.Type)).RefType.SizeOf;
                int offsetValue = ((ABT.ConstLong)offset).Value;
                return new ABT.ConstPtr((uint)(baseValue + scaleValue * offsetValue), ptr.Type, env);
            }
    ...
    public sealed class Sub : BinaryArithmeticOp {
        ...
        public static ABT.Expr GetPointerSubtraction(ABT.Expr ptr, ABT.Expr offset) {
            ...
            if (ptr.IsConstExpr && offset.IsConstExpr) {
                int baseAddressValue = (int)((ABT.ConstPtr)ptr).Value;
                int scaleFactorValue = ((ABT.PointerType)(ptr.Type)).RefType.SizeOf;
                int offsetValue = ((ABT.ConstLong)offset).Value;
                return new ABT.ConstPtr((uint)(baseAddressValue - scaleFactorValue * offsetValue), ptr.Type, offset.Env);
            }
        ...
        public override ABT.Expr GetExpr(ABT.Env env) {
            ...
            if (left.Type.Kind == ABT.ExprTypeKind.POINTER) {
                ...
                if (right.Type.Kind == ABT.ExprTypeKind.POINTER) {
                    ...
                    int scale = leftType.RefType.SizeOf;

                    if (left.IsConstExpr && right.IsConstExpr) {
                        return new ABT.ConstLong((int)(((ABT.ConstPtr)left).Value - ((ABT.ConstPtr)right).Value) / scale, env);
                    }
    ...
    public sealed class LShift : BinaryIntegralOp {
        ...
        public override int OperateLong(int left, int right) => left << right;
        public override uint OperateULong(uint left, uint right) => (uint)((int)left << (int)right);
    ...
    public sealed class Less : BinaryLogicalOp {
        ...
        public override int OperateLong(int left, int right) => Convert.ToInt32(left < right);
        public override int OperateULong(uint left, uint right) => Convert.ToInt32(left < right);
        public override int OperateFloat(Single left, Single right) => Convert.ToInt32(left < right);
        public override int OperateDouble(Double left, Double right) => Convert.ToInt32(left < right);
	...
	public sealed class LogicalAnd : BinaryLogicalOp {
        ...
        public override int OperateLong(int left, int right) => Convert.ToInt32(left != 0 && right != 0);
        public override int OperateULong(uint left, uint right) => Convert.ToInt32(left != 0 && right != 0);
        public override int OperateFloat(Single left, Single right) => Convert.ToInt32(left != 0 && right != 0);
        public override int OperateDouble(Double left, Double right) => Convert.ToInt32(left != 0 && right != 0);
