...
namespace CCompiler.ABT
{
    ...
    public abstract partial class ExprType {
        ...
        public const int SIZEOF_DOUBLE = 8;
        public const int SIZEOF_POINTER = 4;

        public const int ALIGN_CHAR = 1;
        public const int ALIGN_SHORT = 2;
        public const int ALIGN_LONG = 4;
        public const int ALIGN_FLOAT = 4;
        public const int ALIGN_DOUBLE = 4;
        public const int ALIGN_POINTER = 4;
    ...
    public partial class VoidType : ExprType {
        ...
        public override int SizeOf => SIZEOF_POINTER;

        public override int Alignment => SIZEOF_POINTER;
    ...
    public partial class CharType : IntegralType {
        ...
        public override int SizeOf => SIZEOF_CHAR;

        public override int Alignment => ALIGN_CHAR;
    ...
    public partial class ShortType : IntegralType {
        ...
        public override int SizeOf => SIZEOF_SHORT;

        public override int Alignment => ALIGN_SHORT;
    ...
    public partial class LongType : IntegralType {
        ...
        public override int SizeOf => SIZEOF_LONG;

        public override int Alignment => ALIGN_LONG;
    ...
    public partial class FloatType : ArithmeticType {
        ...
        public override int SizeOf => SIZEOF_FLOAT;

        public override int Alignment => ALIGN_FLOAT;
    ...
    public partial class PointerType : ScalarType {
        ...
        public override int Alignment => ALIGN_POINTER;
    ...
    public partial class IncompleteArrayType : ExprType {
        ...
        public override int Alignment => this.ElemType.Alignment;
        ...
        public ExprType Complete(int numElems) => new ArrayType(this.ElemType, numElems);
    ...
    public partial class ArrayType : ExprType {
        ...
        public override int SizeOf => this.ElemType.SizeOf * this.NumElems;
    ...
    public partial class StructOrUnionType : ExprType {
        ...
        public override int SizeOf => this._layout.SizeOf;

        public override int Alignment => this._layout.Alignment;
        ...
        private class StructOrUnionLayout {
            ...
            public int Alignment => this.Attribs.Select(_ => _.type.Alignment).Max();
    ...
    public partial class FunctionType : ExprType {
        ...
        public static FunctionType Create(ExprType ret_type, List<Tuple<string, ExprType>> args, Boolean is_varargs) {
            Tuple<int, IReadOnlyList<int>> r_pack = Utils.PackArguments(args.ConvertAll(_ => _.Item2));
